...
public class AppColors {
	...
	public final static Color HOME_BACKGROUND = Color.decode("#34495E");
	public final static Color TIME_PAD_DIGITS = Color.decode("#ECF0F1");
	public final static Color APP_GREEN = Color.decode("#2ECC71");
	public final static Color APP_RED = Color.decode("#E74C3C");
